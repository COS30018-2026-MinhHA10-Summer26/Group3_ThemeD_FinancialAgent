"""
Three-Version Evaluation Report — document_3 / query_1
...
==========================================================================================
  Weighted Metrics (3 versions) — document_3/query_1
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Criterion            | Weight | V0 Score | V1 Score | V2 Score | Δ V0→V1 | Δ V1→V2 | Δ V0→V2 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Financial Accuracy   |    25%  |      100 |        0 |       75 |   -100 |    +75 |    -25 |
...
| Completeness         |    10%  |       20 |        0 |       85 |    -20 |    +85 |    +65 |
| Query Satisfaction   |    10%  |      100 |        0 |       70 |   -100 |    +70 |    -30 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    37.00 |     0.00 |    73.75 |    -37 |    +73 |    +36 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: +36 pts absolute  |  +99.32% relative
==========================================================================================
...
METRICS = \
    {
        ...
        "overall_v1": 0.0,
        "overall_v2": 73.75,
        "improvement_v0_to_v1": -37.0,
        "improvement_v1_to_v2": 73.75,
        "improvement_v0_to_v2": 36.75,
        "improvement_pct_v0_to_v2": 99.32
    }
