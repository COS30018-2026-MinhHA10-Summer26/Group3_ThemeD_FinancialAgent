"""
Three-Version Evaluation Report — document_1 / query_3
...
==========================================================================================
  Weighted Metrics (3 versions) — document_1/query_3
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Criterion            | Weight | V0 Score | V1 Score | V2 Score | Δ V0→V1 | Δ V1→V2 | Δ V0→V2 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Financial Accuracy   |    25%  |       85 |       70 |       70 |    -15 |     +0 |    -15 |
| Business Analysis    |    15%  |       70 |       75 |       75 |     +5 |     +0 |     +5 |
| Risk Assessment      |    15%  |       60 |       70 |       70 |    +10 |     +0 |    +10 |
| Actionable Advice    |    15%  |       50 |       80 |       80 |    +30 |     +0 |    +30 |
| Evidence Usage       |    10%  |       40 |       60 |       60 |    +20 |     +0 |    +20 |
| Completeness         |    10%  |       75 |       90 |       90 |    +15 |     +0 |    +15 |
| Query Satisfaction   |    10%  |       90 |       85 |       85 |     -5 |     +0 |     -5 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    68.75 |    74.75 |    74.75 |     +6 |     +0 |     +6 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: +6 pts absolute  |  +8.73% relative
==========================================================================================
