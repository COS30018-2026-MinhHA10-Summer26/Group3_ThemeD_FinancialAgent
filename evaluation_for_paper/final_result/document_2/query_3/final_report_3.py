"""
Three-Version Evaluation Report — document_2 / query_3
...
==========================================================================================
  Weighted Metrics (3 versions) — document_2/query_3
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
...
| Risk Assessment      |    15%  |       50 |       70 |       80 |    +20 |    +10 |    +30 |
| Actionable Advice    |    15%  |       60 |       75 |       80 |    +15 |     +5 |    +20 |
| Evidence Usage       |    10%  |       70 |       70 |       80 |     +0 |    +10 |    +10 |
| Completeness         |    10%  |       80 |       85 |       90 |     +5 |     +5 |    +10 |
| Query Satisfaction   |    10%  |       90 |       90 |       90 |     +0 |     +0 |     +0 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    73.50 |    80.75 |    85.25 |     +7 |     +4 |    +11 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: +11 pts absolute  |  +15.99% relative
==========================================================================================
...
METRICS = \
    {
        ...
        "improvement_v0_to_v2": 11.75,
        "improvement_pct_v0_to_v2": 15.99
    }
