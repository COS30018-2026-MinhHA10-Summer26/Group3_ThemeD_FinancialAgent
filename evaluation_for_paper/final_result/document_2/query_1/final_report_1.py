"""
Three-Version Evaluation Report — document_2 / query_1
...
==========================================================================================
  Weighted Metrics (3 versions) — document_2/query_1
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
...
| Risk Assessment      |    15%  |        0 |       60 |       80 |    +60 |    +20 |    +80 |
| Actionable Advice    |    15%  |        0 |       70 |       80 |    +70 |    +10 |    +80 |
| Evidence Usage       |    10%  |        0 |       90 |       90 |    +90 |     +0 |    +90 |
| Completeness         |    10%  |       20 |      100 |      100 |    +80 |     +0 |    +80 |
| Query Satisfaction   |    10%  |      100 |      100 |      100 |     +0 |     +0 |     +0 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    37.00 |    84.00 |    90.00 |    +47 |     +6 |    +53 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: +53 pts absolute  |  +143.24% relative
==========================================================================================
...
METRICS = \
    {
        ...
        "overall_v1": 84.0,
        "overall_v2": 90.0,
        "improvement_v0_to_v1": 47.0,
        "improvement_v1_to_v2": 6.0,
        "improvement_v0_to_v2": 53.0,
        "improvement_pct_v0_to_v2": 143.24
    }
