"""
Three-Version Evaluation Report — document_6 / query_3
...
==========================================================================================
  Weighted Metrics (3 versions) — document_6/query_3
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
...
| Completeness         |    10%  |        0 |        0 |       70 |     +0 |    +70 |    +70 |
| Query Satisfaction   |    10%  |      100 |        0 |       50 |   -100 |    +50 |    -50 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    35.00 |     0.00 |    27.50 |    -35 |    +27 |     -7 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: -7 pts absolute  |  -21.43% relative
==========================================================================================
...
METRICS = \
    {
        ...
        "overall_v1": 0.0,
        "overall_v2": 27.5,
        "improvement_v0_to_v1": -35.0,
        "improvement_v1_to_v2": 27.5,
        "improvement_v0_to_v2": -7.5,
        "improvement_pct_v0_to_v2": -21.43
    }
