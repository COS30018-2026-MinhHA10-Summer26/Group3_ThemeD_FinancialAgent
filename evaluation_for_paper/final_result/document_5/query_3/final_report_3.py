"""
Three-Version Evaluation Report — document_5 / query_3
...
==========================================================================================
  Weighted Metrics (3 versions) — document_5/query_3
==========================================================================================
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Criterion            | Weight | V0 Score | V1 Score | V2 Score | Δ V0→V1 | Δ V1→V2 | Δ V0→V2 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| Financial Accuracy   |    25%  |       90 |        0 |        0 |    -90 |     +0 |    -90 |
| Business Analysis    |    15%  |       30 |        0 |        0 |    -30 |     +0 |    -30 |
| Risk Assessment      |    15%  |       20 |        0 |       20 |    -20 |    +20 |     +0 |
| Actionable Advice    |    15%  |       10 |       60 |       60 |    +50 |     +0 |    +50 |
| Evidence Usage       |    10%  |       40 |        0 |        0 |    -40 |     +0 |    -40 |
| Completeness         |    10%  |       70 |       40 |       40 |    -30 |     +0 |    -30 |
| Query Satisfaction   |    10%  |       80 |        0 |        0 |    -80 |     +0 |    -80 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
| OVERALL (weighted)   |        |    50.50 |    13.00 |    16.00 |    -37 |     +3 |    -34 |
+----------------------+--------+----------+----------+----------+--------+--------+--------+
  V0→V2 total improvement: -34 pts absolute  |  -68.32% relative
==========================================================================================
...
METRICS = \
    {
        ...
        "overall_v1": 13.0,
        "overall_v2": 16.0,
        "improvement_v0_to_v1": -37.5,
        "improvement_v1_to_v2": 3.0,
        "improvement_v0_to_v2": -34.5,
        "improvement_pct_v0_to_v2": -68.32
    }
